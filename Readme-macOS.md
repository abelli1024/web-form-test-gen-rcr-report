...
## RCR Report – Experimental Environment and Instructions (Apple Silicon Example)
...
* JDK: Oracle OpenJDK 17.0.4  
  Download (macOS aarch64): [jdk-17.0.4_macos-aarch64_bin.dmg](https://download.oracle.com/java/17/archive/jdk-17.0.4_macos-aarch64_bin.dmg)
